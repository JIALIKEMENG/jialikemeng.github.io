Canta是一个应用卸载器，通过[Shizuku](https://github.com/RikkaApps/Shizuku)实现免root卸载系统应用组件，并支持恢复。在使用 Canta 之前，需要[下载Shizuku](https://shizuku.rikka.app/download/)安装并[激活它 ](https://shizuku.rikka.app/guide/setup/)。
